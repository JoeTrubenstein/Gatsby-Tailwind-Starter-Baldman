  ...
  <header>
    <section className="text-gray-600 body-font">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <img className="h-24 center" src={GatsbyIcon} alt=""/>
        </div>
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">{siteTitle}</h1>
          <p className="mb-8 leading-relaxed">I really like Gatsby and Tailwind. This starter template lets me spin up a new project quickly.</p>
